...
$iddm = $_GET['iddm'];
// echo $iddm;
$sql = "SELECT * FROM sanpham WHERE sp_iddm = $iddm";
$result = mysqli_query($connect,$sql);
//  if (!$query) {
//         echo "Error inserting data: " . mysqli_error($connect);
//     };
$sql_danhmuc = "SELECT * FROM danhmuc WHERE dm_id = $iddm";
...
?>
    ...
    <!-- Products Start -->
    <?php while($row_renderdm = (mysqli_fetch_assoc($result_danhmuc))){ ?>
    <h4 class="section-title position-relative text-uppercase mx-xl-5 mb-4"><span class="bg-secondary pr-3"><?php echo $row_renderdm['dm_name'] ?></span></h4>
     <?php } ?>
